...
GAME_DATA.scenario = {
  ...
  kounAfterRecord: [
    ...
    { who: "player", text: "重い重い。……でも、そう読みたくなるくらい、大事な一言だったんだね" },
    { who: "opa", text: "一つは今日の社長のぶん、もう一つは帰ってこない未来の社長のぶん……うぇぇ……" },
    { who: "player", text: "初日に遺言はないでしょ。……いや、ある？　覚悟決めてる人なら、ある……？" },
