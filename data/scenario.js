...
GAME_DATA.scenario = {
  ...
  kounAfterRecord: [
    ...
    { who: "player", text: "……あ" },
    { who: "player", text: "……自分で書いて飾ってるなら、それは読んでほしいやつだ" },
    { who: "opa", text: "でしょう！？　どん底から始めたことを、笑い話にしてほしかったんです……っ" },
    { who: "aibou", text: "当たることもあるんだね" },
    { who: "opa", text: "そして「コーヒー、二つ淹れといて」。……二つ。これは遺言です！" },
    { who: "player", text: "重い重い" },
    { who: "opa", text: "一つは今日の社長のぶん、もう一つは帰ってこない未来の社長のぶん……うぇぇ……" },
    { who: "player", text: "会社作った初日に遺言書く人いないって" },
    ...
    { who: "aibou", text: "このままじゃ船にはまらない。記録の本当の温度が読めたら、形が決まる。拠点でやろう" }
  ],
  ...
  alchemy_koun0412: [
    ...
    { who: "player", text: "重い" },
    { who: "aibou", text: "でも「逆から読むな」は、おぱが当たってた。油断しないでね" },
